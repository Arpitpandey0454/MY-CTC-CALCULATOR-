                ...
                <div className="bg-white/60 dark:bg-gray-900 backdrop-blur-lg rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-800 p-6 sm:p-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3">
                        ...
                        <div className="p-6 rounded-2xl bg-amber-50 dark:bg-amber-950/10 border border-amber-200 dark:border-amber-100">
                            ...
                            <div className="mt-4">
                                <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300">Tax Regime</h5>
                        ...
                        {results && (
                            <div className="p-6 rounded-2xl bg-sky-50 dark:bg-sky-950/30 border border-sky-200 dark:border-sky-700">
                                ...
                                <div>
                                    <h5 className="font-semibold mb-2 text-gray-800 dark:text-gray-100">Cost to Company Breakup</h5>
                        ...
                        {results && (
                            <div className="p-6 rounded-2xl bg-rose-50 dark:bg-rose-950/10 border border-rose-200 dark:border-rose-100">
                                <h4 className="font-semibold mb-3 text-gray-800 dark:text-gray-100">Earnings & Deductions</h4>
                                ...
                                <hr className="border-gray-200/80 dark:border-gray-700/80 mb-4" />

                                <div>
                                    <h5 className="font-semibold mb-2 text-gray-800 dark:text-gray-100">Deductions (Annual)</h5>
